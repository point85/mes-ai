  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border p-4 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-medium text-gray-800">CPG Demo &mdash; Juice Bottling</h3>
      ...
      <div className="bg-white rounded-lg border p-4 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-medium text-gray-800">Electronics Demo &mdash; PCB Assembly</h3>
            <p className="text-sm text-gray-500 mt-1">
      ...
      <div className="bg-white rounded-lg border p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
          <div>
            <h4 className="font-medium text-gray-700 mb-1">Inbound (ERP &rarr; MES)</h4>
          ...
          <div>
            <h4 className="font-medium text-gray-700 mb-1">Outbound (MES &rarr; ERP)</h4>
            <ul className="list-disc list-inside space-y-0.5">
