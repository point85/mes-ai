/**
 * Route Create dialog — creates a standalone process route (not tied to a product).
 */
...
import { useCreateStandaloneRoute } from "../../hooks/useProductDef";
...
export default function RouteCreateDialog({ onClose }: Props) {
  ...
  const mutError = createMut.error;
