...
Seven physical types (the seven SI base quantities plus 'count' for discrete counts):
    mass, length, time, temperature, electrical, force, amount_of_substance, luminous_intensity, count
