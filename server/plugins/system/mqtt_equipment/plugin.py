"""
MQTT Equipment Adapter Plugin.

Wraps the MQTT equipment adapter as a plugin
managed by the plugin framework.

The underlying adapter class reads its configuration from
MES_EQUIP_MQTT_* environment variables via pydantic-settings.
"""
...
class MQTTEquipmentPlugin(MESPlugin):
    """Plugin wrapper for the MQTT equipment adapter."""
    ...
    async def initialize(self, config: dict[str, Any]) -> None:
        ...
        self._adapter = MQTTEquipmentAdapter()
